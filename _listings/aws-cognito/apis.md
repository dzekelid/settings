...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/aws-cognito/apis.md
...
- name: AWS Cognito Merged API - Admin Set User Settings
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/aws-cognito/actionadminsetusersettings-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/aws-cognito/actionadminsetusersettings-get-openapi.md
- name: AWS Cognito Merged API - Set User Settings
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/aws-cognito/actionsetusersettings-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/aws-cognito/actionsetusersettings-get-openapi.md
- name: AWS Cognito Merged API - Admin Set User Settings
  x-api-slug: actionadminsetusersettings-get
  description: Sets all the user settings for a specified user name.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-cognito.png
