...
- name: Microsoft Graph API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/settings/master/_listings/microsoft-graph/users-id|userprincipalname-mailboxsettings-language-get.md
x-common:
- type: x-change-loge
