...
- name: Microsoft Graph API Get User Mailbox Settings
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/microsoft-graph/me-mailboxsettings-timezone-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/microsoft-graph/me-mailboxsettings-timezone-get-postman.md
x-common:
- type: x-change-loge
