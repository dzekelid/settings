...
- name: Microsoft Graph API Update User Mailbox Settings
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/microsoft-graph/users-id|userprincipalname-mailboxsettings-patch-postman.md
x-common:
- type: x-change-loge
