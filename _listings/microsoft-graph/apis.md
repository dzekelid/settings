...
- name: Microsoft Graph API Get User Mailbox Settings
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/microsoft-graph/users-id|userprincipalname-mailboxsettings-automaticrepliessetting-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/microsoft-graph/users-id|userprincipalname-mailboxsettings-automaticrepliessetting-get-postman.md
x-common:
- type: x-change-loge
