...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/aws-lambda/apis.md
...
- name: AWS Lambda API - Get Account Settings
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/aws-lambda/actiongetaccountsettings-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/aws-lambda/actiongetaccountsettings-get-openapi.md
- name: AWS Lambda API - Get Account Settings
  x-api-slug: actiongetaccountsettings-get
  description: Returns a customer's account settings.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Compute_AWSLambda.png
