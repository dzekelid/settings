...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/dezrez/apis.md
specificationVersion: "0.14"
apis:
- name: Dezrez.Rezi.Client.Api - Update the Fee Level Setting for branch
  x-api-slug: apibranchupdatefeelevel-put
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/dezrez/apibranchupdatefeelevel-put-openapi.md
- name: Dezrez.Rezi.Client.Api - Edit Display settings for the Group. Primarily shown
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/settings/master/_listings/dezrez/apigroupiddisplaysettings-put-openapi.md
- name: Dezrez.Rezi.Client.Api - Update the Fee Level Setting for branch
  x-api-slug: apibranchupdatefeelevel-put
  description: Update the fee level setting for branch.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28888-www-dezrez-com.jpg
